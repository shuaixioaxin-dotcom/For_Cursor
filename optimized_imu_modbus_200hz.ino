...
// Reduced for 200Hz target frequency
static const uint16_t RESPONSE_TIMEOUT_MS = 3;      // Reduced from 30ms to 3ms
static const uint32_t BUS_SILENCE_US = 40;          // Reduced from 500us to 40us (3.5 chars @ 921600)
static const uint32_t TX_ENABLE_DELAY_US = 5;      // Reduced from 30us to 5us
static const uint32_t TX_DISABLE_DELAY_US = 10;    // Reduced from 60us to 10us
static const uint32_t FAIL_COOLDOWN_MS = 2;        // Reduced from 20ms to 2ms
static const uint8_t MAX_BACKOFF_SHIFT = 2;        // Reduced from 4 to 2 (max 8ms cooldown)
...
void setup() {
  ...
  Serial.println("# Modbus RTU 200Hz Optimized Version");
  ...
  Serial.println("# Target Frequency: 200Hz");
