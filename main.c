 ...
 * Also supports controlling an IO pin via USART1 commands ("on"/"off").
 * 
 ...
 * - IO Control (PA01): Outputs 3.3V ("on") or 0V ("off")
 * 
...
static void Control_GPIO_Configuration(void)
{
    ...
    GPIO_ResetBits(CTRL_GPIO_PORT, CTRL_GPIO_PIN); // Default 0V
}
