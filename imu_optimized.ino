...
// 关键优化：大幅降低超时和延迟以提升频率
static const uint16_t RESPONSE_TIMEOUT_MS = 8;      // 从30ms降到8ms
static const uint32_t BUS_SILENCE_US = 150;         // 从500us降到150us
static const uint32_t TX_ENABLE_DELAY_US = 10;     // 从30us降到10us  
static const uint32_t TX_DISABLE_DELAY_US = 20;    // 从60us降到20us
static const uint32_t FAIL_COOLDOWN_MS = 10;       // 从20ms降到10ms
static const uint8_t MAX_BACKOFF_SHIFT = 3;        // 从4降到3
...
void setup() {
  ...
  Serial.println("# Modbus RTU raw read enabled (OPTIMIZED for 200Hz)");
